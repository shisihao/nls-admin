...
interface TreeFilterProps {
  ...
  checkStrictly?: boolean; // 在显示复选框的情况下，是否严格的遵循父子不互相关联的做法 ==> 非必传，默认为 false
  defaultValue?: any; // 默认选中的值 ==> 非必传
  isAll?: boolean;  // 是否显示全部选项 ==> 非必传，默认为 false
}
...
onBeforeMount(async () => {
  ...
  if (props.requestApi) {
    ...
    props.isAll && treeAllData.value.unshift({ id: "", [props.label]: "全部" });
  }
});
