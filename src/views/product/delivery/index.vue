<template>
  <div class="table-box">
    <ProTable ref="proTable" title="运费模版列表" :columns="columns" :request-api="getTableList">
      <!-- 表格 header 按钮 -->
...
const columns: ColumnProps[] = [
  ...
  { prop: "name", label: "模版名称", minWidth: 160, align: "left",
    search: {
      el: 'input',
      label: "模版名称",
      key: 'keywords',
      props: { placeholder: '请输入 模版名称' }
    }
  },
